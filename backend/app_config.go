...
func parseConfig() AppConfig {
	...
	mode := flag.String("mode", "local", "Run mode: local|control (agent is alias for local)")
	...
	defaultAccount := flag.String("account", "", "Default account used by the web UI (empty requires manual input in UI)")
